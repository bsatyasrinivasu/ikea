...
const ImageHo = () => {
  return (
    ...
    <div className="relative group ">
      <img src="a4.png" alt="Your Image" className="w-[] h-[] group-hover:opacity-100 " />
       <div5>
...
<div className='flex items-center'>
    <div className='p-1 h-[160px] w-[130px] text-black bg-white'>
        <p className='font-semibold text-[13px]'>MALM</p>
        <p className='text-[10px]'>4-drawer chest, black-brown,</p>
                <p className='font-bold text-xl'>$ 139.99</p>
